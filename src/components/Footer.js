...
const Footer = () => {
  ...
  return (
    <div className='p-md-5 p-4 position-relative' style={{background:'#878787'}} >
    <div className='px-lg-5 mx-xl-5'>
     ...
     <div className='general-footer row py-2 py-md-5 '>
        ...
        <div className=' col d-flex  flex-column text-white gap-4 align-items-md-center '>
         ...
         <Link className='text-white text-decoration-none' onClick={toggleContactButtons}>Contact</Link>
         {showContactButtons && (
        <div role="group" aria-label="Basic example" className="btn-group position-absolute footer-btn"  >
