          ...
          <div className="general-footer row py-2 py-md-5 ">
            ...
            <div className="col-12 col-sm-4 mt-5 mt-sm-0 d-flex align-items-center flex-column text-white gap-3 ">
              ...
              <div className="d-flex gap-4">
               {/* <a href=""> <img src={FB} alt="social" /></a> */}
                <a href="https://www.instagram.com/legalmoplatform"><i class="fa-brands fa-linkedin fa-2xl"></i></a>
                <a href="https://www.linkedin.com/company/legalmo/"><i class="fa-brands fa-instagram fa-2xl"></i></a>
                <a href="https://x.com/legalmoplatform"><i class="fa-brands fa-x-twitter fa-2xl"></i></a>
              </div>
            </div>
          </div>
