  ...
  return (
    <form className="" onSubmit={handleSubmit}>
      <div className="position-relative">
        ...
        <div className="profile-container">
          <div className="d-flex gap-3 align-items-center">
            ...
            />
            <h5 className="mt-2" style={{ fontWeight: "500" }}>
              Profile
            </h5>
          </div>
      ...
      <div className="mt-5 pt-5 px-lg-1">
        <div>
          <h5 className="mt-sm-5 pt-sm-5" style={{ fontWeight: "600" }}>
            Expertise
          </h5>
          <div className="mt-3">
            {areasOfPractiseOptions.map((option, index) => (
              <button
                ...
                type="button"
                className={`btn ${
                  formData?.areasOfPractise.includes(option)
                    ? "btn-primary"
          ...
          >
            <div className="col-12 col-md-3">
              ...
              <p className="text-muted">
                Enter an alternate email if you would like to be contacted via a
                different email
              </p>
            </div>
            <input
