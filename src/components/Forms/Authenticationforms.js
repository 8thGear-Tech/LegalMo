...
export function SignUpForm({ formTitle, fields, onSubmit, submitButtonLabel }) {
  ...
  }, [formData, fields, hasPasswordFields]);
    ...
    <div className="login-card mt-lg-3">
      <div className="card p-5  m-auto">
        ...
        <form onSubmit={handleNext}>
          ...
          <button type="submit" className="btn btn-secondary" style={{ fontSize: '20px', width: '100%' }}>
            {submitButtonLabel}
          </button>
        </form>
      </div>
...
{passwordError && <div className="text-danger">{passwordError}</div>}
          ...
          <Link to='/password-reset' className='d-flex mb-4 justify-content-end text-decoration-none text-secondary'>
          ...
          <p className='text-center mt-4'>
            ...
            <Link onClick={toggleSignUpButtons}className='text-decoration-none'style={{color:'#032773'}}>Sign up</Link>
          
          </span>
          
          </p>
          {showSignUpButtons && (
        <div role="group" aria-label="Basic example" className="btn-group form-sign-btn position-absolute gap-1">
