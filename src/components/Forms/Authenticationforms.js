    ...
    <div>
      ...
      >
        <div className="modal-dialog modal-dialog-centered" role="document">
          <div
            className="modal-content p-sm-5 p-3"
            style={{ backgroundColor: "#D9DAF9" }}
          >
    ...
    <div className="login-card mt-lg-3">
      <div className="card py-5 px-sm-5 px-4 m-auto">
        <div className="text-center mb-4">
          <h5 className="mb-2" style={{ fontWeight: "700", color: "#323233" }}>
            {formTitle}
          </h5>
        ...
        <form onSubmit={(e) => handleNext(e)}>
          ...
          <button
            type="submit"
            className={`btn ${
              isFormComplete ? "btn-primary btn-newPrimary" : "btn-secondary"
            }`}
    ...
    <div className="login-card mt-lg-5" style={{ backgroundColor: "#FEFEFF" }}>
      <div className="card p-5 m-auto">
        <div className="text-center mb-4">
          ...
          <p className="p-small" style={{ color: "#7E7E7F" }}>
            Welcome back!
          </p>
        </div>
