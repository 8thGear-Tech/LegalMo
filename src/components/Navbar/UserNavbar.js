        ...
        <div className="container-fluid px-md-5 px-3 justify-content-between ">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav mx-auto mb-2 mb-lg-0 gap-2 gap-lg-3 short-links">
              ...
              {userType === "admin" ||
                (userType === "lawyer" && authenticatedToken && (
                  <li className="nav-item">
                    <NavLink
                      className="nav-link"
                      to="/lawyer/dashboard"
              ...
              {userType === "admin" ||
                (userType === "lawyer" && authenticatedToken && (
                  <li className="nav-item">
                    <NavLink
                      className="nav-link"
                      to={`/lawyer/available-jobs/${userId}`}
                      activeclassname="active"
                    >
                      Jobs
                    </NavLink>
              ...
              {userType === "admin" ||
                (userType === "company" && authenticatedToken && (
                  <li className="nav-item">
                    <NavLink
                      className="nav-link"
              ...
              <li className="nav-item">
                <Link
                  className={`nav-link ${isContactActive}`}
              ...
              {showContactButtons && (
                <div
                  ...
                  className="btn-group contact-btn position-absolute"
                >
                ...
                {userType === "admin" ||
                  (userType === "company" && authenticatedToken && (
                    <li className="nav-item">
                      <Link
                        className="nav-link "
                        to={`/company/profile/${userId} `}
                      >
                        <img
                          src={details?.profileImage?.url || user}
                          alt="profile-image"
                          style={{
                            width: "60px",
                            height: "60px",
