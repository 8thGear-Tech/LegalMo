  ...
  <span className="navbar-toggler-icon"></span>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className="d-block d-lg-flex gap-2 gap-lg-3 align-items-center">
      {
                ...
                <ul className="navbar-nav ">
                  <li className="nav-item">
                    <Link className="nav-link" to="/login"><NavLoginbtn text='Log in'/></Link>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link" onClick={toggleSignUpButtons}>
                      <NavSignUpbtn/></Link>
                  </li>
                  {showSignUpButtons && (
                <div role="group" aria-label="Basic example" className="btn-group sign-btn position-absolute gap-1" >
                  <Link to='/signup/asacompany' className="btn btn-primary">As a Company</Link>
                  <div className='my-2' style={{borderLeft:'1px solid white'}}></div>
                  <Link to='/signup/asalawyer' type="button" className="btn btn-primary">As a Lawyer</Link>
