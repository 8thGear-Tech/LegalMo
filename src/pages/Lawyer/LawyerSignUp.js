...
const LawyerSignUp = () => {
  ...
  const nextLawyerFields = [
    {
      name: "scnNumber",
      label: "Supreme Court Enrollment Number (SCN)",
      type: "text",
      required: true,
    },
    {
      name: "cacNumber",
      label: "CAC Accreditation Number",
      type: "text",
      required: false,
    },
...

    {
      ...
      options: [
        ...
        {
          label: "International Trade and Investment",
          value: "International Trade and Investment",
        },
