  ...
  return (
    <div>
     ...
     <section className='py-5 px-3 px-sm-5 mb-5'>
      {isEditing ? (
        <LawyerProfileForm initialDetails={details} onSave={handleSave} onCancel={handleCancel} /> ):(
  ...
  >
    Add Expertise
        ...
        <div className='d-flex flex-column text-center order-md-2 order-1'>
            <div>
                <img src={details?.profileImage?.url} alt='lawyer' className='profile-img' style={{ background: '#FFF', padding: '10px', borderRadius: '200px', boxShadow: '0px 4px 10px 0px rgba(0, 0, 0, 0.25)'}}/>
            </div>
