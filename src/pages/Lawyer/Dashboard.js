...
const LawyerDashboard = () => {
  ...
  const { getPendingJobs, getCompletedJobs, getJobs, requestDetail } =
    lawyerRoute();
  ...
  return (
    <div>
                ...
                {jobs.map((job) => {
                 ...
                 <i className="bi bi-cloud-upload mb-3"></i> */}
                          <button
                            ...
                            onClick={() => handleRequestDetailsShow(job)}
                          >
      ...
      {selectedJob && (
        <div>
          ...
          >
            ...
            >
              <div
                className="modal-content gap-3 p-3 p-sm-5"
                style={{ width: "90%" }}
              >
                ...
                <div className="modal-body ">
                  ...
                  <div className="form-group gap-2 mt-5">
                    ...
                    <div
                      className="d-flex justify-content-between gap-5 mt-3 align-items-center"
                      style={{ maxWidth: "auto" }}
                    >
                      <div>
                        {(selectedJob?.companyFile &&
                          selectedJob?.companyFileName) ||
                        (selectedJob?.adminFile &&
                          selectedJob?.adminFileName) ? (
      ...
      {selectedJob && (
        <div>
          <div
            className={`modal fade px-2 px-md-0 ${
              showRequestDetailsModal ? "show" : ""
            }`}
              ...
              <div className="modal-content gap-3 p-3 p-sm-5">
                <div className="modal-header">
                  ...
                  <button
                    type="button"
                    className="btn-close"
                    onClick={handleRequestDetailsClose}
                  ></button>
                </div>
                <div className="modal-body ">
                  <h6 className="mb-2" style={{ color: "#5F5F5F" }}>
                  ...
                  <div className="d-flex flex-column mt-5">
                    <button
                      ...
                      onClick={handleRequestDetailsSend}
                    >
                      Send
                    </button>
                  </div>
