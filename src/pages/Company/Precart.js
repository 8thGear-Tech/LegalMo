          ...
          >
            <div className="d-flex gap-3 product-card">
              {productGroup.map((product, innerIndex) => (
                <div
                  key={product._id}
                  className={`col-xl-${12 / productsPerSlide.xl} col-lg-${
                    12 / productsPerSlide.lg
                  } col-md-${12 / productsPerSlide.md} col-sm-${
                    12 / productsPerSlide.sm
                  } col-12 mb-5`}
                >
                  <div
                  ...
                  >
                    ...
                    >
                      <p className="p-small" style={{ fontWeight: "500" }}>
                        {product?.productName}
                      </p>
    ...
    <div className="px-lg-5 mx-2 d-block d-sm-flex justify-content-between gap-4 flex-wrap review-container ">
      <div className="d-flex flex-column gap-1 mb-5 average-review">
        ...
        {progressReviews.map((progressReview) => {
          ...
          return (
            <div
              key={progressReview.id}
              className="d-flex align-items-center pre-cart"
            >
          ...
          return (
            <div
              ...
              className={`col-12 col-md-${
                reviews.length === 1 ? "12" : "6"
              } mb-4 review-card${index >= 3 ? " mt-4" : ""}`}
            >
...
export function Precart() {
  ...
  const handleReserve = () => {
    ...
    if (userType === "company") {
      ...
      localStorage.setItem(
        "reservedItems",
        JSON.stringify(existingReservedItems)
      );
  ...
  return (
      ...
      <div>
        <section style={{ backgroundColor: "#CFCFCF" }} className="p-5 ">
          <div className=" d-block d-md-flex gap-5 justify-content-center text-align-center align-content-center text-center">
            <div
              className="card mb-3"
              style={{ borderRadius: "25px", width: "20rem" }}
            >
              <img
                src={product?.productImage}
                alt={product?.productName}
                className=""
                style={{ borderRadius: "none", height: "319px" }}
              />
              <div
              ...
              >
                <p className="p-small text-white" style={{ fontWeight: "500" }}>
                  {product?.productName}
                </p>
              </div>
            </div>
            ...
            >
              <div className="d-flex  flex-column justify-content-center align-items-center text-align-center gap-2">
                ...
                >
                  Your order will be delivered between 7-10 working days after
                  purchase
                </p>
          ...
          <div className="px-xl-5 mx-xl-5">
            <div className="my-5 justify-content-center align-content-center mx-lg-5 px-sm-5">
              ...
              <textarea
                ...
                rows="8"
                placeholder="Type more details about your purchase"
                value={details}
        ...
        <section className="py-3  py-sm-5 px-sm-5 px-4">
          ...
          <ReviewContainer
            ...
            label={label}
            reviews={reviews}
            averageStarIconsFill={averageStarIconsFill}
                    ...
                    <div>
                      {[1, 2, 3, 4, 5].map((rating) => (
                        <span
                          ...
                          className={`me-1 bi bi-star${
                            rating <= selectedRating ? "-fill" : ""
                          }`}
                        ></span>
                      ))}
                    </div>
    ...
    />
                  ...
                  <div className="form-group mb-4">
                    <label name="reviewTitle" className="form-label">
                  ...
                  <div className="form-group mb-3">
                    <label name="reviewText" className="form-label">
                      Your review
                    </label>
                    <textarea
                      className="form-control"
